...
const categoryNames={product:'AI Products & Experiences',research:'Digital Humanities & Research',operations:'Content, Community & Growth Ops'};
...
document.querySelector('#project-detail').innerHTML=`
  <section class="detail-hero">
    ...
    <div><p class="detail-summary">${project.summary}</p><p class="detail-role">My role: ${project.role}</p><div class="tag-list">${tags}</div></div>
  </section>
  ${media}
