window.PROJECTS = [
  {id:'qingdong',title:'轻动',en:'Qingdong: AI Movement Coach',year:'2026.08',role:'产品策划 · 交互设计',categories:['product','strategy'],featured:true,image:'assets/projects/qingdong-demo-poster.jpg',video:'assets/videos/qingdong-demo.mp4',videoPoster:'assets/projects/qingdong-demo-poster.jpg',summary:'打通抖音 Feed 兴趣卡触达、摄像头动作识别、豆包陪练反馈与成果分享的完整闭环，让久坐用户坐着即可完成 50 秒轻运动，从 1,300 余份参赛作品中突围，获抖音 AI 创变者计划 2026 黑客松全国 TOP10。',problem:'久刷、久坐用户即使感到颈肩或腰背紧绷，也往往不愿中断当前场景；传统运动教程的搜索、观看与模仿链路较长，独自跟练时也缺少即时反馈。',actions:['设计 Feed 卡触达、部位选择、摄像头校准、动作跟练、完成结算与成果分享的端到端路径','将动作识别拆分为姿势校准、动作达标、保持计时、回到中立位与自动完成等状态','完成 PRD、四个核心界面、Feed 卡交互方案与演示 Demo，并纳入隐私、安全和异常恢复机制'],gallery:[{image:'assets/projects/qingdong-douyin-top10-certificate.jpg',caption:'抖音 AI 创变者计划 2026 黑客松全国 TOP10：作品《轻动：豆包轻量化运动陪练》从 1,300 余份参赛作品中突围'}],metrics:[['全国 TOP10','抖音 AI 创变者计划'],['50 秒','单次轻运动体验'],['Feed→AI','完整体验闭环']],tags:['AI Product','Motion Recognition','Mini Program','UX Design'],reflection:'AI 产品的关键不只是展示识别能力，还要找到技术能够自然进入的场景，并通过明确反馈、安全边界与低操作成本促成完整体验。'},
  ...
  {id:'gusu',title:'《姑苏繁华图》数字活化',en:'Prosperous Suzhou Scroll',year:'2025',role:'独立策划 · 叙事设计 · 开发',categories:['culture'],featured:true,image:'assets/projects/gusu-cover.jpg',video:'assets/videos/gusu-scroll.mp4',link:'http://82.157.189.119/',summary:'以商贾、文人、平民三重身份重新进入古代长卷，获 2026 首届大学生国际数字人文节“最佳技术应用作品”，并获牛津大学 DHOxSS 2026 海报竞赛 Winner。',problem:'数字长卷常只是把线下观看搬到屏幕，缺少情境、身份和叙事参与。',actions:['设计三重身份视角与差异化旁白','用横向滚动模拟长卷观看方式','将文学叙事转换为交互节点和信息层'],gallery:[{image:'assets/projects/gusu-idhf-best-technical-application.jpg',caption:'2026 首届大学生国际数字人文节“最佳技术应用作品”'},{image:'assets/projects/gusu-oxford-dhoxss-2026-poster-winner.jpg',caption:'牛津大学 DHOxSS 2026 海报竞赛 Winner（第二名）'}],metrics:[['最佳技术应用','2026 大学生国际数字人文节'],['Winner','Oxford DHOxSS 2026 海报竞赛'],['3','身份视角']],tags:['Digital Heritage','Narrative','Interaction'],reflection:'数字活化不是增加动效，而是建立新的观看位置和理解路径。'},
...
window.STAR_STORIES = {
  qingdong: {
    ...
    r:'项目完成完整 PRD、小程序四个核心界面、Feed 卡交互方案及演示 Demo，形成从信息流内容触达到 AI 动作跟练及分享传播的产品闭环，并从 1,300 余份参赛作品中突围，获抖音 AI 创变者计划 2026 黑客松全国 TOP10。'
  },
  jingmeng: {
  ...
  gusu: {
    ...
    r:'全部核心模块已完成并部署，用户可通过国内地址进入体验；作品获 2026 首届大学生国际数字人文节“最佳技术应用作品”，并获牛津大学数字人文暑期学校（DHOxSS 2026）海报竞赛 Winner。当前版本也明确保留了大图加载、视角数量与国际化等后续优化方向。'
  },
  lingya: {
