window.PROJECTS = [
  ...
  {id:'gushu-mask',title:'古蜀覆面：三星堆数字神面',en:'Ancient Shu Digital Mask',year:'2026',role:'项目负责人 · 全栈开发',categories:['product'],featured:true,image:'assets/projects/gushu-mask-cover.jpg',video:'assets/videos/gushu-mask.mp4',summary:'用 AI 设计、3D 建模与 AR 试戴，让用户生成自己的三星堆数字神面。',problem:'文博展示往往停留在观看层，用户难以建立角色代入和主动传播。',actions:['串联素材参数、AI 平面生成与 3D 建模 API','开发摄像头识别和动作触发文化讲解','用个性化桌宠建立体验到分享的传播闭环'],metrics:[['1st','Nextstep 一等奖'],['AI→3D','多模态链路'],['AR','动作交互']],tags:['Generative AI','3D','AR','Cultural Tech'],reflection:'文化科技产品需要把知识融入动作、角色和可带走的个人成果，而不是额外附上一段说明。'},
  {id:'heritage',title:'文化遗产智能计算',en:'Intelligent Heritage Computing',year:'2025—至今',role:'省级大创项目负责人',categories:['research'],featured:true,image:'assets/projects/heritage-computing.png',summary:'将文物纹样从图像像素转化为具有文化语义的可计算单元。',problem:'文物数字化常停留在粗粒度图像保存，难以对纹样和文化基因进行细粒度检索与解释。',actions:['建立视觉解构、语义切片与跨模态语义映射路径','使用 SAM 系列模型进行文物图像分割','编制传统器物纹样智能标注指南'],metrics:[['省级','创新训练项目'],['SAM','图像语义分割'],['跨模态','图像—文本映射']],tags:['Digital Humanities','SAM','Annotation','Multimodal'],reflection:'技术并不是研究目的；关键是把模型输出转化为可解释、可复用的文化知识结构。'},
  {id:'gusu',title:'《姑苏繁华图》数字活化',en:'Prosperous Suzhou Scroll',year:'2025',role:'独立策划 · 叙事设计 · 开发',categories:['research'],featured:true,image:'assets/projects/gusu-cover.jpg',video:'assets/videos/gusu-scroll.mp4',summary:'以商贾、文人、平民三重身份重新进入古代长卷。',problem:'数字长卷常只是把线下观看搬到屏幕，缺少情境、身份和叙事参与。',actions:['设计三重身份视角与差异化旁白','用横向滚动模拟长卷观看方式','将文学叙事转换为交互节点和信息层'],metrics:[['3','身份视角'],['Scroll','长卷交互'],['Narrative','情景化解读']],tags:['Digital Heritage','Narrative','Interaction'],reflection:'数字活化不是增加动效，而是建立新的观看位置和理解路径。'},
  {id:'sushi',title:'二苏诗词情感识别',en:'Su Shi & Su Zhe Sentiment',year:'2025',role:'独立产品设计与全栈开发',categories:['product','research'],featured:false,image:'assets/projects/sushi-sentiment.jpg',video:'assets/videos/sushi-sentiment.mp4',summary:'用大模型情感标注与可视化，把古典诗词转化为可探索的数据体验。',problem:'传统诗词阅读中，情绪演变和作品间关系难以被整体观察。',actions:['设计诗词情感识别与标签生成流程','将模型结果转化为图表与交互反馈','根据退出节点优化反馈清晰度和学习动线'],metrics:[['NLP','情感识别'],['LLM','文本标注'],['Web','交互可视化']],tags:['AI Product','Digital Humanities','NLP','Visualization'],reflection:'它同时是 AI 产品和数字人文项目：产品侧关注反馈体验，研究侧关注情感分类是否具有文学解释力。'},
  {id:'children-edu',title:'儿童公益教学工具',en:'Children Education Tool',year:'2025',role:'独立产品设计与全栈开发',categories:['product'],featured:false,image:'assets/projects/children-education.jpg',video:'assets/videos/children-education.mp4',summary:'用结构化记录和数据看板替代低效的微信群学习打卡。',problem:'学习记录碎片化、通知被淹没，学生进步不可见，教师难以精准指导。',actions:['设计登录—打卡—记录—排行榜闭环','为学生和教师分别提供周/月数据看板','设计一人多娃与多人一娃账户模式'],metrics:[['+50%','模块停留时长'],['+20%','周回访率'],['+30%','理解准确率']],tags:['User Research','Dashboard','Education','Full-stack'],reflection:'真实场景中的账户关系和反馈机制，往往比功能数量更决定产品能否长期使用。'},
  {id:'lingya',title:'腾讯灵芽 AIGC 产品运营',en:'Tencent Lingya Campus Growth',year:'2026',role:'校园大使 · 产品运营',categories:['operations'],featured:true,summary:'从 0 到 1 建立校园获客和种子创作者孵化体系。',problem:'AIGC 产品在校园场景中面临认知门槛高、使用情境模糊和创作者供给不足。',actions:['联动社团、社群和朋友圈矩阵多渠道拉新','引入种子创作者并提供工具教学与创作指导','建立创作者反馈到产品模板优化的闭环'],metrics:[['2,000+','校园触达'],['75%','完课率'],['180','自然新增用户']],tags:['Growth','Creator Ops','Feedback Loop','AIGC'],reflection:'增长不只是曝光；内容教学、创作者成功和反馈迭代共同决定渠道质量。'},
  {id:'douyin',title:'武汉大学抖音俱乐部',en:'WHU Douyin Club',year:'2025',role:'主编及主要负责人',categories:['operations'],featured:false,image:'assets/projects/douyin-club.png',summary:'以校园生活共鸣为内容支点，建立有辨识度的校园账号和用户社群。',problem:'校园账号容易陷入同质化通知内容，缺少稳定的人设、选题机制和用户参与。',actions:['建立热点监测、选题和内容 SOP','根据数据迭代发布时间与内容形式','通过共创和互动激励沉淀校园用户'],metrics:[['百万+','累计播放'],['+30%','单月互动率'],['0→1','内容体系']],tags:['Content Strategy','Community','Data'],reflection:'稳定增长来自可重复的内容机制，而不是偶然爆款。'},
  {id:'hi-acho',title:'网易 Hi Acho 用户研究',en:'AI English User Research',year:'2025',role:'用户研究项目负责人',categories:['operations','research'],featured:false,image:'assets/projects/hi-acho.png',summary:'用问卷与深访定位 AI 口语产品的体验短板。',problem:'需要明确 AI 口语产品的教学接受度、核心流失节点和优化优先级。',actions:['完成问卷设计、信效度和交叉分析','组织多城市线下深访','整合定量与定性证据形成优化建议'],metrics:[['1,022','有效问卷'],['20+','用户访谈'],['4','覆盖城市']],tags:['User Research','SPSS','Interview','AI Education'],reflection:'用户研究的价值不是罗列意见，而是将证据转化为可排序的产品决策。'},
  {id:'personal-content',title:'个人账号内容增长',en:'Personal Content Growth',year:'2025—至今',role:'独立运营',categories:['operations'],featured:false,image:'assets/projects/personal-content.png',summary:'从 0 到 1 验证场景化内容与社交裂变的冷启动路径。',problem:'新账号缺少初始分发和明确定位，需要用低成本实验找到有效内容模型。',actions:['提炼选题模板与封面标题公式','用 A/B 测试优化内容方向','分别适配视频号社交链与小红书搜索分发'],metrics:[['8W+','视频号单条播放'],['500%','7 天涨粉'],['1.5W+','小红书单篇浏览']],tags:['Cold Start','A/B Test','Social Growth'],reflection:'同一内容不能机械跨平台分发，平台关系结构决定包装和增长机制。'}
];

window.AUDIENCE_VIEWS = {
  product:{label:'AI 产品',projects:['cyber-ancestor','moonbot','gushu-mask']},
  operations:{label:'AI 产品运营',projects:['lingya','cyber-ancestor','douyin']},
  academic:{label:'科研',projects:['gusu','heritage','sushi']}
};
...
window.STAR_STORIES = {
  ...
  gusu: {
    ...
    r:'全部核心模块已完成并部署，用户可通过国内地址进入体验；当前版本也明确保留了大图加载、视角数量与国际化等后续优化方向。'
  },
  lingya: {
  ...
  douyin: {
    ...
    r:'账号累计播放量超过百万，单月互动率提升 30%，并形成能够重复运行的校园内容生产与社群互动机制。'
  },
  'hi-acho': {
  ...
  'personal-content': {
    ...
    r:'视频号单条内容播放超过 8 万，七天粉丝增长 500%；小红书单篇浏览超过 1.5 万，并实现月度粉丝增长 500%。'
  }
};
